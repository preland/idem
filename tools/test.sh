...
# the suite must test against; IDEM_COMPILER=idc.py switches to the reference
# implementation, which emits byte-identical C and is the tie-breaker if the two
